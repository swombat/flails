...
describe Flails::IO::AMF3::Types do
  ...
  it "should hold the correct AMF3 type values" do
    ...
    Flails::IO::AMF3::Types::OBJECT_STATIC.should       == 0x00
    Flails::IO::AMF3::Types::OBJECT_EXTERNAL.should     == 0x01
    Flails::IO::AMF3::Types::OBJECT_DYNAMIC.should      == 0x02
    Flails::IO::AMF3::Types::OBJECT_PROXY.should        == 0x03
