module RubyAMF
  module Configuration
    ...
    # Alternatively, you may set this to the name of a Flex class that you wish to use for your collections.
    # For example, "com.woobius.api.collections.ValueObjectArrayCollection"
