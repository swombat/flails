module RubyAMF
  module Configuration
    ...
    # => Use ValueObjectArrayCollection
    # A Flails only configuration variable.  Setting this to true will cause Flails to return ValueObjectArrayCollection
    # instead of ArrayCollection instances.  This setting will override ClassMappings.use_array_collection
    #ClassMappings.use_value_object_array_collection = true
